...
const HomeDashboard =({isUserLoggedIn}) =>{
  ...
  return (
    <div className={'background-image'} style={{backgroundImage: 'url(/survey-background.jpg)'}}>
      ...
      <ul className='home-content'>
        {isUserLoggedIn? <li> <Link to='/surveys'>Surveys Dashboard</Link></li> : <li aria-hidden onClick={startLogin}>Please Login to continue !</li>}
